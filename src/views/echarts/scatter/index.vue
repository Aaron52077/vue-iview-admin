    ...
    <div class="gc-panel">
        ...
        <div class="gc-container">
            <div class="gc-container__title">
                <sButtonGroup>
                    <sButton type="primary" to="https://v-charts.js.org/#/scatter" target="_blank">v-charts scatter</sButton>
            ...
            <sRow :gutter="16">
                <sCol :xs="24" :sm="24" :lg="12">
                    <div class="echart-block">
                        <ve-scatter :data="chartData" :settings="chartSettings" v-bind="pubSetting"></ve-scatter>
                    </div>
                </sCol>
                <sCol :xs="24" :sm="24" :lg="12">
                    <div class="echart-block">
