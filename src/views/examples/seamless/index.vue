                ...
                <sCol :xs="24" :sm="12" :lg="12">
                    <mVlist :totalHeight="300" :defaultHeight="40">
                        <mSeamlessScroll 
                            ...
                            :waitTime="waitTime">
                            <sCellGroup>
                                <sCell v-for="(item, index) in listData" :key="index" :title="item.title" :extra="item.date" />
                            </sCellGroup>
                        </mSeamlessScroll>
                    </mVlist>
                </sCol>
                <sCol :xs="24" :sm="12" :lg="12">
                    <mSeamlessScroll :data="newsList" :direction="direction2" :limitMoveNum="2" class="seamless-warp">
                        <ul class="seamless-items">
                            <li class="seamless-item" v-for="item in newsList" :key="item.title">{{item.title}}</li>
                        </ul>
                    </mSeamlessScroll>
                    <sRow :gutter="16" class="gc-block__row">
                        <sCol :xs="24" :sm="8" :lg="8">
                            <div class="gc-container__h1">上下方向</div>
                            <sSwitch class="gc-block__switch" true-color="#13ce66" false-color="#ff4949" @on-change="onSwitch1($event)">
                        ...
                        <sCol :xs="24" :sm="8" :lg="8">
                            ...
                            <sSwitch class="gc-block__switch" true-color="#13ce66" false-color="#ff4949" @on-change="onSwitch2($event)">
                        ...
                        <sInputNumber class="gc-block__input" :min="0" :max="5" v-model.trim="step"></sInputNumber>
                        </sCol>
                    </sRow>
                    <sRow :gutter="16" class="gc-block__row">
                        <sCol :xs="24" :sm="8" :lg="8">
                        ...
                        <sCol :xs="24" :sm="8" :lg="8">
                            ...
                            <sInputNumber class="gc-block__input" :min="0" v-model.trim="singleHeight"></sInputNumber>
                        </sCol>
                        <sCol :xs="24" :sm="8" :lg="8">
                            <div class="gc-container__h1">单行停顿时间(单位：ms)</div>
                            <sInputNumber class="gc-block__input" :min="0" :disabled="singleHeight === 0" v-model.trim="waitTime"></sInputNumber>
                        </sCol>
                    </sRow>
                </sCol>
            </sRow>
