  ...
  methods: {
    ...
    map_init(qq) {
      ...
      let center = vm.currentValue.point
        ? new qq.maps.LatLng(vm.currentValue.point[1], vm.currentValue.point[0])
        : new qq.maps.LatLng(30.54762, 104.06498);
      // 使用联想输入的input的id
      let autocomplete = new qq.maps.place.Autocomplete(
        document.getElementById("map_keyword" + vm._uid)
      );
      let keyword = "";
      // 获取dom元素添加地图信息
