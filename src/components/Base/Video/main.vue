    ...
    <div class="video-container">
        <div class="__cov-video-container" @mouseenter="mouseEnterVideo" @mouseleave="mouseLeaveVideo">
            <video :class="{ 'hide-cursor': !state.contrlShow }" class="__cov-video" :poster="options.poster">
                <source v-for="(source, index) in sources" :src="source.src" :type="source.type" :key="index" />
            </video>
...
export default {
    ...
    beforeDestroy() {
        off(document, 'mousemove', this.mouseMoveAction)
        off(document, 'mouseup', this.mouseUpAction)
    },
    methods: {
        init() {
            ...
            on(document, 'mousemove', this.mouseMoveAction)
            on(document, 'mouseup', this.mouseUpAction)
        },
        initCore() {
            this.initVol()
            this.initVideo()
