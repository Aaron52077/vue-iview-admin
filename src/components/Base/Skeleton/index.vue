<template>
  <div>
    <div class="gc-skeleton" v-if="loading" :class="{ 'gc-skeleton__animate': animate }">
      <div
        class="gc-skeleton__avatar"
        :style="avatarStyles"
        :class="{ 'gc-skeleton__avatar--round': avatarShape }"
      ></div>
      <div class="gc-skeleton__content">
        <div class="gc-skeleton__title" v-if="title" :style="{ width: titleWidth }"></div>
        <div
          class="gc-skeleton__row"
