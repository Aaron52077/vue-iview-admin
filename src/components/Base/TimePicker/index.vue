    ...
    <div class="gc-datapicker">
        <template v-if="hasLabel">
            ...
            <sDatePicker 
                ...
                :options="optionsTime"
                style="width: 180px" 
                @on-change="startTimeChange"></sDatePicker>
            ...
            <sDatePicker 
                ...
                :options="optionsTime"
                style="width: 180px" 
                @on-change="endTimeChange"></sDatePicker>
            <sButton class="gc-datapicker__btn" type="primary" @click="queryHandle">{{innerText}}</sButton>
        </template>
        <template v-else>
            <sDatePicker 
                v-bind="$attrs" 
