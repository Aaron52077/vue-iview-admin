<template>
    <div class="gc-error" v-if="errorLogs && errorLogs.length > 0">
        ...
        <sModal class="gc-dia-main" width="1000" v-model="visible" transfer no-data-text="无错误日志" :mask-closable="false" footer-hide>
            <div slot="header" class="gc-dia-title">错误日志<sButton style="margin-left: 15px;" type="primary" icon="md-trash" @click.native="onClick">错误演示</sButton><sButton style="margin-left: 15px;" type="primary" icon="md-trash" @click="clearAll">清空全部</sButton></div>
